...
### array
เป็นรูปแบบการเก็บข้อมูลที่มีรูปแบบเป็นช่องมาต่อๆกัน วิธีการเรียกข้อมูลออกมาจะต้องใช้เลขช่องของ array เช่น <code>a[3]</code> (array a ช่องที่ 3) โดยการสร้าง array จะต้องประกาศขนาดและชนืดของตัวแปรเอาไว้ตั้งแต่แรก
```java
// การประกาศ array 
